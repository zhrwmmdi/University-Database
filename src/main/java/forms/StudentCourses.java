...
public class StudentCourses extends javax.swing.JFrame {
    ...
    private void updateRelations() throws SQLException {
        ...
        PreparedStatement state = Tools.getConnection()
        ...
        state = Tools.getConnection().prepareStatement("delete from section where course_id=? and sec_id=? and semester=? and year=?;");
