...
public class InstructorStudentsList extends javax.swing.JFrame {

     public InstructorStudentsList(){
        initComponents();
     }
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InstructorStudentsList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new InstructorStudentsList().setVisible(true);
        });
    }
